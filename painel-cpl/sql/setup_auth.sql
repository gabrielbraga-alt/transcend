...
-- ============================================================
-- 4. Congelamento do status "Otimizado" por 3 dias
--    Guarda quando o cliente foi marcado como otimizado, pra o
--    n8n não sobrescrever o status automaticamente antes disso.
-- ============================================================
alter table clientes add column if not exists otimizado_em timestamp with time zone;
